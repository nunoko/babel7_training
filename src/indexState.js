...
class App extends React.Component {
    ...
    return(
        <div>
            ...
            */
            ...
            {this.state.isTodaySpecial && <div>Today is special</div>}
        </div>
        )
    }
    ...
    handleClickCount=()=>{
        ...
        const isTodaySpecial = true
        // ปกติ this.setState จะทำแค่ 1 ครั้ง เพราะค่ามันจะอยู่ในคิว
